...
def launch_setup(context):
    ...
    if compiled == 'True':
        ...
        xf_mic_asr_offline_package_path = get_package_share_directory(
            'xf_mic_asr_offline')
    else:
    ...
    mic_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(xf_mic_asr_offline_package_path,
                         'launch/mic_init.launch.py')), )

    voice_interactive_node = Node(
        package='xf_mic_asr_offline',
        executable='voice_interactive.py',
        output='screen',
        # huanjingbianliang
